...
/* ============================================================
   SISTEMA DE ENVIO
   Lê a resposta real do fórum (o Forumeiros devolve 200 mesmo
   quando recusa), leva os campos ocultos do formulário (tid/lt)
   e reenvia automaticamente quando cai no antiflood.
   ============================================================ */
...
const sendMP=(username,subject,message)=>comRetentativa(()=>postMP({username,subject,message}));
const sendMPGroup=(groupId,subject,message)=>comRetentativa(()=>postMP({[CAMPO_GRUPO]:String(groupId),subject,message}));
